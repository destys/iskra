 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".confidence__slider")) new core(".confidence__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".featured-service__slider")) {
                const featuredThumbs = new core(".featured-service__slider_thumbs", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
                ...
                new core(".featured-service__slider", {
            ...
            if (serviceItems.length) serviceItems.forEach((service => {
                ...
                if (serviceSlider && serviceSliderThumbs) {
                    const serviceItemThumbs = new core(serviceSliderThumbs, {
                        modules: [ Navigation ],
                        observer: true,
                        observeParents: true,
                        slidesPerView: 4,
            ...
            if (document.querySelector(".product__slider") && document.querySelector(".product__slider_thumbs")) {
                const productThumbs = new core(".product__slider_thumbs", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
